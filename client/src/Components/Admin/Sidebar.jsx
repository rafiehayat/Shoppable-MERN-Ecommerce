...
export default function Sidebar() {
  return (
      ...
      <Link to="#" className="list-group-item list-group-item-action btn-color text-light" aria-current="true"><i className='fa fa-home'></i><span className='float-end'>Home</span></Link>
