    ...
    <>
      <div className="container-fluid my-3 w-100">
        <div className="w-75 m-auto">
            <h5 className='text-center btn-color p-2 text-light'><span className='text-warning fs-4'>Create </span> Your Account </h5>
           {
            show?
                ...
                <div className="mb-3">
                    <div className="btn-group w-100">
                       <Link to="/login" className='btn btn-success' >Login</Link>
                        <button type='submit' className='btn btn-color text-light'>Signup</button>
                    </div>
                </div>
            </form>
        </div>
