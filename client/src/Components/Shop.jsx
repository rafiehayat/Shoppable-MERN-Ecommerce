...
export default function Shop() {
  ...
  let [activeButton, setActiveButton] = useState("allCategory");
        ...
        <div className="row">
          <div className='col-md-3'>
            <button
              ...
              className="list-group-item list-group-item-action btn-color  "
            >
              Main Categories
            </button>
            ...
            <button
              ...
              className="list-group-item list-group-item-action btn-color  mt-3 "
            >
              SubCategories
            </button>
            ...
            <h6 className='btn-color my-3 text-light p-2'>Price Filter</h6>
            <div className="row">
              ...
              <div className="my-3">
                <button className='btn btn-color text-light w-100' onClick={applyPriceFilter}>Apply</button>
              </div>
            </div>
          </div>
            ...
            <div className="row">
              {
                product.map((item, index) => {
                  return (
                    <div key={index} className="col-lg-3 col-md-6 wow fadeInUp pb-3" data-wow-delay="0.1s">
