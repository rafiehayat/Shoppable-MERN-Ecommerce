            ...
            <div className="row g-4">
                <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div className="d-flex py-5 px-4">
                        ...
                        <div className="ps-4">
                            <h5 className="mb-3">Best Products</h5>
            ...
            <div className="row g-5">
                <div className="col-lg-6 pt-4" style={{minHeight: "400px"}}>
                    <div className="position-relative h-100 wow fadeIn" data-wow-delay="0.1s">
                        <img className="position-absolute img-fluid w-100 h-100"  style={{objectFit: "cover"}} alt=""/>
                        <div className="position-absolute top-0 end-0 mt-n4 me-n4 py-4 px-5" style={{background: "rgba(0, 0, 0, .08)"}}>
                            {/* <h1 className="display-4 text-color mb-0">15 <span className="fs-4">Years</span></h1>
                            <h4 className="text-color">Experience</h4> */}
                        </div>
                    </div>
                </div>
                <div className="col-lg-6">
                    <h6 className="text-color text-uppercase">// About Us //</h6>
                    <h1 className="mb-4"><span className="text-color">Shoppable</span> Is The Best Place For Your Shopping Experience</h1>
                    ...
                    <a href="" className="btn btn-color text-light py-3 px-5">Read More<i className="fa fa-arrow-right ms-3"></i></a>
                </div>
            </div>
        </div>
    </div>
